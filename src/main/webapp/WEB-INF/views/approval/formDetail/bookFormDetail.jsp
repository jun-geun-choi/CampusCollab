      ...
      <div class="main-content">
        ...
        <table class="info-table mb-4">
          <tr>
            ...
            <th>작성일자</th><td><fmt:formatDate value="${approval.createdDate}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
          </tr>
          <tr>
            <th>작성자</th><td>${approval.writerName}</td>
            <th>소속부서</th><td>${approval.approvalDepartmentName}</td>
          </tr>
          <tr>
            <th>참조자</th><td></td>
            <th>수령하는 곳</th><td>${approval.receiverDepartmentName}</td>
          </tr>
          <tr>

...
<%--                    <div class="col-md-4 mb-2">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-2">
                        <label class="form-label">수령</label>
                        <div class="input-group">
                            <input name="receiverDepartmentName" type="text" id="receiverDept" class="form-control" >
                            <button class="btn btn-outline-secondary" type="button" id="selectReceiverBtn">검색</button>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                ...
                <div class="row mb-3">
                    <div class="col-md-4 mb-2">
                        <label class="form-label">신청</label>
                        <div class="input-group">
                            <input type="text" id="requestDept" class="form-control" readonly>
                            <button class="btn btn-outline-secondary" type="button" id="selectRequestDeptBtn">검색</button>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">

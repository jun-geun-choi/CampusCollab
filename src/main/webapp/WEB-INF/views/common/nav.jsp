  ...
  <div class="container-fluid">
    <a class="navbar-brand d-flex align-items-center" href="/">
				<span class="logo-crop">
					<img src="${pageContext.request.contextPath}/resources/image/logo.png" alt="GROUVY 로고" class="logo-img">
				</span>
    </a>
    <ul class="navbar-nav mb-2 mb-lg-0">
      <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/approval/main/draft">문서결재</a></li>
      <!-- 커서 active-->
      <li class="nav-item"><a class="nav-link" href="/file/personal">파일관리함</a></li>
      ...
      <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/dept/list">팀 구성</a></li>
          ...
          <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle"
            ...
            <c:choose>
              <c:when test="${(empty profilePath) or (profilePath eq 'null')}">
                <img src="${pageContext.request.contextPath}/resources/image/free-icon-person-7542670.png" alt="기본 프로필"
                     class="rounded-circle" width="36" height="36"/>
              </c:when>
              <c:otherwise>
                <img src="${pageContext.request.contextPath}/resources/${profilePath}" alt="사용자 프로필"
                     class="rounded-circle" width="36" height="36"/>
              </c:otherwise>
            </c:choose>
